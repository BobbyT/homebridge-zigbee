...
class GledoptoRgbBulb extends HomeKitDevice {
  ...
  onDeviceReady() {
    ...
    const hue = this.getServiceCharacteristic('Bulb', 'Hue')
    const saturation = this.getServiceCharacteristic('Bulb', 'Saturation')
